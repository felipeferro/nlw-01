...
const Detail = () =>{
  ...
  function handlerNavigarionBack(){
    navigation.goBack();
  }
  ...
  function handlerWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse nos pontos de coleta de resíduos`)
  ...
  return (
    <SafeAreaView style={{flex:1}}>
      <View style={styles.container}>
        <TouchableOpacity onPress={handlerNavigarionBack}>
