...
const Points = () =>{
  ...
  function handlenNavigarionBack(){
    navigation.goBack();
  }
  
  function handlenNavigateToDetail(id: number){
  ...
  return (
    <SafeAreaView style={{flex:1}}>
      <View style={styles.container}>
        <TouchableOpacity onPress={handlenNavigarionBack}>
          ...
          { initialPosition[0] !==0 && (
            ...
            {points.map(point =>(
              <Marker 
                ...
                onPress={() => handlenNavigateToDetail(point.id)}
                coordinate={{
